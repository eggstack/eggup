...
Status: ready to author on Archive Extraction M001b closure (`plans/closure/archive-extraction/001b-status.md`, run `36222536670`). M001a is historical/superseded; no archive integration is implemented by this status update.
...
| M002 archive extraction handoff | ready to author | — | — | M001b closed |
