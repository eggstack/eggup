...
Status: conditionally closed; see `plans/closure/acquisition-transport/007-status.md`.

Closed the UTF-8 diagnostic, finite artifact-byte-bound, and curl pathname-reopen defects. Windows hosted live-loopback curl evidence remains unavailable and is not claimed.

### M008 — Sub-second deadline truthfulness corrective

Class: invariant/corrective.

Plan: `plans/implementation/acquisition-transport/008-subsecond-deadline-truthfulness-corrective.md`.

Status: closed (hosted-qualified on Archive M001b run `36222536670`); see `plans/closure/acquisition-transport/008-status.md`.
